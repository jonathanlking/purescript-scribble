...
(function(exports) {exports.time = function() {
...
(function(exports) {
  ...
  var sessionFunctor = new Data_Functor.Functor(function (f) {
      return function (v) {
          return function (c) {
              return Data_Functor.map(Control_Monad_Aff.functorAff)(function (v1) {
                  return Data_Tuple.Tuple.create(c)(f(v1.value1));
              })(v(c));
          };
      };
  });
  var sessionApply = new Control_Apply.Apply(function () {
      return sessionFunctor;
  }, function (v) {
      return function (v1) {
          var h = function (dictFunctor) {
              return Data_Functor.map(dictFunctor)(function (v2) {
                  return function (v3) {
                      return new Data_Tuple.Tuple(v3.value0, v2.value1(v3.value1));
                  };
              });
          };
          return function (c) {
              return Control_Apply.apply(Control_Monad_Aff.applyAff)(h(Control_Monad_Aff.functorAff)(v(c)))(v1(c));
          };
      };
  });
  var sessionApplicative = new Control_Applicative.Applicative(function () {
      return sessionApply;
  }, function (x) {
      return function (c) {
          return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(new Data_Tuple.Tuple(c, x));
          ...
          return function (dictIsSymbol) {
              return function (dictTransport) {
                  return function (dictEncodeJson) {
                      return function (x) {
                          return function (v) {
                              return Data_Functor.map(Control_Monad_Aff.functorAff)(Data_Tuple.Tuple.create(Unsafe_Coerce.unsafeCoerce(v)))(Scribble_Core.uSend(dictTransport)(v.value0)(Data_Argonaut_Encode_Class.encodeJson(dictEncodeJson)(x)));
                          };
                      };
                  };
              };
              ...
              return function (dictTransport) {
                  return function (dictElem) {
                      return function (dictIsSymbol1) {
                          return function (v) {
                              return Unsafe_Coerce.unsafeCoerce(Control_Applicative.pure(sessionApplicative)(Data_Unit.unit));
                          };
                      };
                  };
              };
              ...
              return function (v) {
                  return Data_Functor.map(Control_Monad_Aff.functorAff)(Data_Tuple.Tuple.create(Unsafe_Coerce.unsafeCoerce(v)))(Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff_AVar.takeVar(v.value1))(function (v1) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                          ...
                          throw new Error("Failed pattern match at Scribble.Indexed line 136, column 10 - line 140, column 46: " + [ v1.constructor.name ]);
                      })())(function (v2) {
                          ...
                          throw new Error("Failed pattern match at Scribble.Indexed line 141, column 5 - line 143, column 24: " + [ v3.constructor.name ]);
                      });
                  }));
              };
          };
  ...
  var session = function (dictTransport) {
                  ...
                  return function (dictIsSymbol) {
                      return function (v) {
                          return function (r) {
                              return function (p) {
                                  return function (v1) {
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(open(dictInitial)(dictTransport)(dictRoleName)(dictIsSymbol)(r)(p))(function (v2) {
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(v1(v2))(function (v3) {
                                              return close(dictTerminal)(dictTransport)(r)(v3.value0);
                                          });
                                      });
                                  };
                              };
  ...
  exports["sessionFunctor"] = sessionFunctor;
  exports["sessionApply"] = sessionApply;
  exports["sessionApplicative"] = sessionApplicative;
...
(function(exports) {
  ...
  var fib = function (n) {
      if (n <= 1) {
          return Control_Applicative.pure(Scribble_Indexed.sessionApplicative)(1);
      };
      if (Data_Boolean.otherwise) {
          return Scribble_Indexed.ibind(Scribble_Indexed.sessionIxMonad)(fib(n - 1 | 0))(function (v) {
              return Scribble_Indexed.ibind(Scribble_Indexed.sessionIxMonad)(fib(n - 2 | 0))(function (v1) {
                  return Scribble_Indexed.ibind(Scribble_Indexed.sessionIxMonad)(Scribble_Indexed.select(Scribble_Protocol_Arithmetic_MathServer.selectS9)(Scribble_Protocol_Arithmetic_MathServer.roleNameServer)(new Data_Symbol.IsSymbol(function () {
                      return "Server";
                  }))(Scribble_WebSocket.transportWebSocket)(Scribble_Indexed.elemTail(Scribble_Indexed.elemTail(Scribble_Indexed.elemHead)))(new Data_Symbol.IsSymbol(function () {
                      return "add";
                  }))(Data_Symbol.SProxy.value))(function () {
                      return Scribble_Indexed.ibind(Scribble_Indexed.sessionIxMonad)(Scribble_Indexed.send(Scribble_Protocol_Arithmetic_MathServer.sendS9Add)(Scribble_Protocol_Arithmetic_MathServer.roleNameServer)(new Data_Symbol.IsSymbol(function () {
                          return "Server";
                      }))(Scribble_WebSocket.transportWebSocket)(Scribble_Protocol_Arithmetic_MathServer.encodeJsonAdd)(new Scribble_Protocol_Arithmetic_MathServer.Add(v, v1)))(function () {
                          return Scribble_Indexed.ibind(Scribble_Indexed.sessionIxMonad)(Scribble_Indexed.receive(Scribble_Protocol_Arithmetic_MathServer.receiveS11)(Scribble_WebSocket.transportWebSocket)(Scribble_Protocol_Arithmetic_MathServer.decodeJsonSum))(function (v2) {
                              return Scribble_Indexed.ipure(Scribble_Indexed.sessionIxMonad)(v2.value0);
                          });
                      });
                  });
              });
      ...
      throw new Error("Failed pattern match at Main line 79, column 1 - line 79, column 89: " + [ n.constructor.name ]);
  };
  var prog = function (n) {
      return Scribble_Indexed.session(Scribble_WebSocket.transportWebSocket)(Scribble_Protocol_Arithmetic_MathServer.initialClient)(Scribble_Protocol_Arithmetic_MathServer.terminalClient)(Scribble_Protocol_Arithmetic_MathServer.roleNameClient)(new Data_Symbol.IsSymbol(function () {
          return "Client";
      }))(Type_Proxy["Proxy"].value)(Scribble_FSM.Role.value)(DOM_HTML_History.URL("ws://localhost:9161"))(Scribble_Indexed.ibind(Scribble_Indexed.sessionIxMonad)(Scribble_Indexed.aff(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)($foreign.time)))(function (v) {
          return Scribble_Indexed.ibind(Scribble_Indexed.sessionIxMonad)(fib(n))(function (v1) {
              return Scribble_Indexed.ibind(Scribble_Indexed.sessionIxMonad)(Scribble_Indexed.aff(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)($foreign.time)))(function (v2) {
                  return Scribble_Indexed.ibind(Scribble_Indexed.sessionIxMonad)(Scribble_Indexed.aff(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log(Data_Show.show(Data_Show.showNumber)(v2 - v)))))(function () {
                      return Scribble_Indexed.ibind(Scribble_Indexed.sessionIxMonad)(Scribble_Indexed.aff(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log(Data_Show.show(Data_Show.showInt)(v1)))))(function () {
                          return Scribble_Indexed.ibind(Scribble_Indexed.sessionIxMonad)(Scribble_Indexed.aff(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("woady"))))(function () {
                              return Scribble_Indexed.ibind(Scribble_Indexed.sessionIxMonad)(Scribble_Indexed.select(Scribble_Protocol_Arithmetic_MathServer.selectS9)(Scribble_Protocol_Arithmetic_MathServer.roleNameServer)(new Data_Symbol.IsSymbol(function () {
                                  return "Server";
                              }))(Scribble_WebSocket.transportWebSocket)(Scribble_Indexed.elemTail(Scribble_Indexed.elemHead))(new Data_Symbol.IsSymbol(function () {
                                  return "quit";
                              }))(Data_Symbol.SProxy.value))(function () {
                                  return Scribble_Indexed.send(Scribble_Protocol_Arithmetic_MathServer.sendS9Quit)(Scribble_Protocol_Arithmetic_MathServer.roleNameServer)(new Data_Symbol.IsSymbol(function () {
                                      return "Server";
                                  }))(Scribble_WebSocket.transportWebSocket)(Scribble_Protocol_Arithmetic_MathServer.encodeJsonQuit)(Scribble_Protocol_Arithmetic_MathServer.Quit.value);
                              });
                          });
                      });
                  });
  ...
  var main = Control_Monad_Aff.launchAff(prog(20));
  exports["fib"] = fib;
  exports["main"] = main;
  exports["prog"] = prog;
