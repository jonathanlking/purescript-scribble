                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(checkLinearity(v))(function (v1) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(uReceive(dictTransport)(v.value0))(function (v2) {
                                      ...
                                      if (lab$prime instanceof Data_Maybe.Just) {
                                          var $122 = Data_Record_Unsafe.unsafeHas(lab$prime.value0)(row);
                                          if ($122) {
                                      ...
                                      throw new Error("Failed pattern match at Scribble.Core line 223, column 3 - line 230, column 81: " + [ lab$prime.constructor.name ]);
                                  });
                              });
                          };
                      };
                  ...
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(checkLinearity(v))(function (v1) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff_AVar.takeVar(v.value1))(function (v2) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                              ...
                              throw new Error("Failed pattern match at Scribble.Core line 101, column 8 - line 105, column 44: " + [ v2.constructor.name ]);
                          })())(function (v3) {
                              ...
                              throw new Error("Failed pattern match at Scribble.Core line 106, column 3 - line 108, column 34: " + [ v4.constructor.name ]);
                          });
                      });
                  });
              };
...
(function(exports) {
  ...
  var fib = function (n) {
      return function (c) {
          ...
          throw new Error("Failed pattern match at Main line 147, column 1 - line 147, column 127: " + [ n.constructor.name, c.constructor.name ]);
      };
  };
  var prog = function (n) {
  ...
  var buyer1 = Scribble_Core.multiSession(Scribble_Protocol_Multiparty_TwoBuyer.roleNameBuyer1)(new Data_Symbol.IsSymbol(function () {
      return "Buyer1";
  }))(Scribble_Protocol_Multiparty_TwoBuyer.protocolNameTwoBuyer)(new Data_Symbol.IsSymbol(function () {
      return "TwoBuyer";
  }))(Scribble_Protocol_Multiparty_TwoBuyer.protocolRoleNamesTwoBuyer)(Scribble_Type_SList.consSymbols(new Data_Symbol.IsSymbol(function () {
      ...
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Scribble_Core.send(Scribble_Protocol_Multiparty_TwoBuyer.sendS9)(Scribble_Protocol_Multiparty_TwoBuyer.roleNameSeller)(new Data_Symbol.IsSymbol(function () {
          return "Seller";
      }))(Scribble_WebSocket.transportWebSocket)(Scribble_Protocol_Multiparty_TwoBuyer.encodeJsonBook)(c)(new Scribble_Protocol_Multiparty_TwoBuyer.Book("War and Peace")))(function (v) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Scribble_Core.receive(Scribble_Protocol_Multiparty_TwoBuyer.receiveS11)(Scribble_WebSocket.transportWebSocket)(Scribble_Protocol_Multiparty_TwoBuyer.decodeJsonQuote)(v))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Buyer1: Quoted \xa3" + Data_Show.show(Data_Show.showInt)(v1.value0.value0))))(function () {
                  var cont = Data_Ord.min(Data_Ord.ordInt)(10)(v1.value0.value0);
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Scribble_Core.send(Scribble_Protocol_Multiparty_TwoBuyer.sendS12)(Scribble_Protocol_Multiparty_TwoBuyer.roleNameBuyer2)(new Data_Symbol.IsSymbol(function () {
                      return "Buyer2";
                  }))(Scribble_WebSocket.transportWebSocket)(Scribble_Protocol_Multiparty_TwoBuyer.encodeJsonContribution)(v1.value1)(new Scribble_Protocol_Multiparty_TwoBuyer.Contribution(cont)))(function (v2) {
                      return Scribble_Core.choice(Scribble_Protocol_Multiparty_TwoBuyer.branchS13)(Scribble_Protocol_Multiparty_TwoBuyer.terminalBuyer1)(Scribble_WebSocket.transportWebSocket)(Scribble_Core.functionCons(Scribble_Core.functionCons(Scribble_Core.functionNil)))(Type_Row.listToRowCons(Type_Row.listToRowCons(Type_Row.listToRowNil)())())(v2)({
                          agree: function (c4) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Scribble_Core.receive(Scribble_Protocol_Multiparty_TwoBuyer.receiveS13Agree)(Scribble_WebSocket.transportWebSocket)(Scribble_Protocol_Multiparty_TwoBuyer.decodeJsonAgree)(c4))(function (v3) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Buyer1: Buyer2 agreed!")))(function () {
                                      return Scribble_Core.send(Scribble_Protocol_Multiparty_TwoBuyer.sendS14)(Scribble_Protocol_Multiparty_TwoBuyer.roleNameSeller)(new Data_Symbol.IsSymbol(function () {
                                          return "Seller";
                                      }))(Scribble_WebSocket.transportWebSocket)(Scribble_Protocol_Multiparty_TwoBuyer.encodeJsonTransfer)(v3.value1)(new Scribble_Protocol_Multiparty_TwoBuyer.Transfer(cont));
                                  });
                              });
                          }, 
                          quit: function (c4) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Scribble_Core.receive(Scribble_Protocol_Multiparty_TwoBuyer.receiveS13Quit)(Scribble_WebSocket.transportWebSocket)(Scribble_Protocol_Multiparty_TwoBuyer.decodeJsonQuit)(c4))(function (v3) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Buyer1: Buyer2 quit!")))(function () {
                                      return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(v3.value1);
                                  });
                              });
                          }
